...
public class DateUtil {
     ...
     * 时间格式化字符串
     */
    private static final String DATETIME_MASK = "yyyy-MM-dd'T'HH:mm:ss";
     ...
     * @return dates
     */
    public static List<String> displayBetweenTwoDay(String startTime,
                                                    String endTime) {
        List<String> dates;
     ...
     * @return dates
     */
    public static List<String> displayBetweenTwoMonth(String startTime,
                                                      String endTime) {
        List<String> dates;
        dates = new ArrayList<String>();
        try {
    ...
    public static double calDay(Date start, Date end) {
        long startTime = start.getTime();
        long endTime = end.getTime();
        return (endTime - startTime) / 1000 / 3600.0 / 24;
    }
     ...
     * @return Date 日期的开始时间；例如：2017-08-12 00:00:00格式的时间
     */
    public static Date getDateBegin(String dateTimeStr) {
        Date dateTime = DateUtil.getDateTime(dateTimeStr);
        return DateUtil.getBeginTime(dateTime);
    }
     ...
     * @return Date 日期的开始时间；例如：2017-08-12 23:59:59格式的时间
     */
    public static Date getDateEnd(String dateTimeStr) {
        Date dateTime = DateUtil.getDateTime(dateTimeStr);
        return DateUtil.getEndTime(dateTime);
    }
    ...
    public static Date getDateTime(String dateTimeStr) {
        return DateUtil.getDate(dateTimeStr, DateUtil.DATETIME_MASK);
    }

    /**
     * <p>Description: 对时间进行加小时计算 </p>
     *
     * @param date  要操作的日期
     * @param hours 要加多少小时
     * @return 处理后的时间。</br>eg：2018-5-11 19：25：23 加3小时  结果为 2018-5-11 22：25：23
     * </br>2018-5-11 19：25：23 加9小时  结果为 2018-5-12 4：25：23
     */
    ...
    public static java.sql.Date getStrSqlDate(String str) {
        SimpleDateFormat df = new SimpleDateFormat(DEFAULT_DATE_MASK);
        try {
    ...
    public static Long getLongSqlDate(String str) {
        SimpleDateFormat df = new SimpleDateFormat(DEFAULT_DATE_MASK);
        try {
